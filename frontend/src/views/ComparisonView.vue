      ...
      <Container class="flex-grow overflow-hidden print:min-h-fit print:overflow-visible">
        ...
        <div class="flex flex-row space-x-10">
          ...
          <TextInformation
            ...
            :label="`近似度 ${store().getDisplayName(comparison.secondSubmissionId)}`"
            tooltip-side="right"
